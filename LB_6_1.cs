...
public class Program
{
	...
	{
	     Human p0 = new Human("Бурдашев", 2003, "Студент");
	     Human p1 = new Human("Кущ", 2002, "Студент");
	     Human p2 = new Human("Потапов", 1992, "Преподаватель");
	     Human p3 = new Human("Иванов", 2003, "Студент");
	     Human p4 = new Human("Бордашевич", 2002, "Студент");
